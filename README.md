...
2. Unzip the data set in your working directory
3. Install R package: plyr, if not already installed
        >install package("plyr")
3. Run run_analysis.R
        >source(.pathname/run_analysis.R)
        >run_analysis.R
4. the new data sets will be placed in your working directory
